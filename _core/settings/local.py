...
from _core.settings.settings_tweaks.app_config import (
    CUSTOM_APP,
    DJANGO_BUILT_IN_APP,
    LOCAL_APP,
    PRIORITY_APP,
...
from _core.settings.settings_tweaks.simple_jwt_config import LOCAL_SIMPLE_JWT_SETTINGG
...
STATICFILES_DIRS = [
    BASE_DIR
    / "static",  # This now includes css/, js/, images/, audio/, video/ # noqa: F405
]
#
